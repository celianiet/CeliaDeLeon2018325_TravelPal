...
var url = api
  ...
  + '&pretty=1';
    ...
    http.onreadystatechange = (e)=>{
        ...
        //flagCode = responseJSON.results[0].annotations.flag;
...
function getRate(){
    ...
    http.onreadystatechange = (e) => {
        ...
        console.log(responseJSON);
        console.log(currency+" get from my-location.js");
...
function getFileCallback(fileEntry) {
    ...
    var text = tripHistory; //String, with all the data I want to save
...
function writeFile(fileEntry, dataObj) {
    ...
    fileEntry.createWriter(function (fileWriter) {
        ...
        if (!dataObj) {
            dataObj = new Blob(['Hello you dont have any trip saved'], { type: 'text/plain' });
        }
...
function myTripOutPut(){
    tripHistory = "The "+currentDate+" I was in "+city+" and the Temperature was "+ temp + " °C  " ;
    document.getElementById("tripData").innerHTML= tripHistory; 
    viewMap();
}
